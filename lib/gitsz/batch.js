 ...
 * @generator
 * @function gsz
 * @yields {gsz} main hashing function
 */
const gsz = require('../bin/gitsz');

function Batch(dir) {
  this.dir = dir;
  // TODO(indutny): symlinks?
  this.proc = spawn(gsz.GIT, ['cat-file', '--batch'], {
 ...
 * getEntry
 * @summary
 * @param {object} getEntry - get the object from git
 * @return {object} returns git object from git cat-file
 */
 ...
 * onMissing
 * @summary
 * @param {object} onMissing - if getEntry faults, this subprocess handles the error catching
